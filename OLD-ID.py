...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Ajmirhossain000/user-agnet/blob/main/mix.txt').text
		ua=open('.mix.txt','w')
...
def chk():
  ...
  try: 
    httpCaht = requests.get("https://github.com/Ajmirhossain000/chil/blob/main/Sata_ok.txt").text 
    if id in httpCaht: 
      ...
      print('\033[92m[•]\033[97mMY ID : AJMIR HOSSAIN [ DARK-HUNTER ]')
